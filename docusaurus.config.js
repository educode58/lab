...
const config = {
  ...
  themeConfig: ({
    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'right',
          value: `
            <span style="font-size: 0.9rem; opacity: 0.7;">Ultima actualizare: 02.12.2025, 11:08</span>
          `,
        },
        {
          type: 'html',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Educode58`,
    },
    prism: {
    ...
    mdxComponents: {
      Image: require.resolve('./src/components/Image.jsx'),
    },
  }),
};
